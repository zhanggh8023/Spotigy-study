...
- # IPD开发方式会有哪些方向？
  - 带着问题找方法，透过现象看本质
  - 我们熟知的一些开发方式，比如：
    - 我拥有某些技术，然后在包装和加工做出产品进行输出
      - 这一类方式，基本是看买家认不认你的产品，认不认同你的技术；二是你的技术是否具有先进性或者说有没有难度，能不能形成技术壁垒；但有技术就能快速产出对应产品，只有有客户，交付不成问题。
    - 我拥有一批客户，他们都有同样的需求，然后去找技术完成对应的订制内容给客户
      - 这一类方式，基本是卖家说的算，缺点就是没有自己的技术，因为是定制化的，技术积累未必能够进行通用，或者说进行复制、规模户；二是遇到技术难点，项目成本以及交付时间难以保障；好处就是一旦完成交付，客户的满意度基本能够保障，资金也能及时回笼。
  - 在探索的过程中，很多人都可以看到这几点，于是有人就会找到平衡点，实现能够共享、批量、复制的产品模式，即并行开发或异步开发，一般叫集成产品开发模式。
  - 如何实现满足内部技术复用，又可个性化需求？书籍中这三点要记录了解清楚
    - 1、产品开发和技术开发以及平台开发要分离
    - 2、技术开发形成工具、零件，打造自己仓库货架，做好技术储备和技术突破
    - 3、产品开发细分客户，形成一个妈妈多个娃，打造多版本和子版本产品
    - ![](image/8.png)
  - 结合公司目前的项目，理解现在数据视窗和虚拟机器人的作用了，公司做城市数据，打造自己的公共共享技术平台和产品平台，形成产品开发的细腰架构。
  - 但目前这是作为产品输出的，作为今后每个城市的公共共享研发基础，零件和部件没有拆分，今后不好复用
  - 一个公司同时进行产品开发和技术开发，如何进行管理和区分？
    - 1、产品开发主要实现平台开发，或者是部分个性化细分客户的订制开发，服务与客户的需求，并将之快速、低成本实现，大多使用成熟可靠技术。前面也说过，它对方市场和财务负责。实现资金的积累，快速的迭代，利用成本、时间领先市场，更多以市场为导向。
    - 2、技术开发最大不同是，在方向或者研究上允许失败，主要是为了是该项技术处于领先地位，从而推动平台产品的价值。一项领先的技术可以像一个黑洞一样，快速吸纳资源，不论是技术标准，人才竞争，还是行业影响力。
  - 产品研发管理这本书主要是华为的内容，所以，可以了解到，华为的集成产品开发又多个版本
    - 产品大版本：Version版本，就是平台版本
    - 细分客户群版本：Release版本，最终交付给用户的产品
    - 客户订制版本：Modification版本，在R版本基础上个性化的版本
    - ![](image/9.png)
- # 管理模式如何应用到企业？
  - 既然要解决问题，就先观察现象，书籍介绍华为时，表示其也同样遇到过或者面临类似的问题：
    - 技术很好，但无法对市场和财务做出支撑
    - 对市场需求反应迟钝，不了解或者及时了解真正的市场需求
    - 重复的造车轮子，工期控制无度
    - 团队独立，资源调用困难，没有全流程负责人
    - 只有研发过程绩效，没有市场和财务成功的指标
    - 销售（需求）与研发人员矛盾突出
  - 为此华为进行总结、创新、改革，主要是将技术研发和产品开发进行了剥离，改变研发技术负责转向市场、财务负责，即产品开发体系。
    - 创新，是在已有的基础。对现有的产品和技术进行共享，在共享中满足差异化
    - 剥离后的技术开发为产品开发服务，但产品开发使用的必须是成熟的货架零件和部件
    - 建立跨部门管理团队，以市场和财务成功为指标
    - 核心技术及关键技术建立自主知识产权
    - 对资源线和产出线分离，资源主要指的是技术研发能力的提升，包括人员任职资格、技术产品的共享
  - 到这里，可以理解公司当前一系列绩效的建立和能力提升的密集培训，人才的培养以及吸纳才是技术开发重要方向
  - 从无到有，从小到大，星星之火可以燎原。从华为的成长过程就可以看出，整机企业目前所处的位置在何处
    - 单项目，单产品阶段：很好理解，理解白了就是类似外包，只关注产品交付、销售
    - 多产品、共享产品和货架平台阶段：有多个基于市场需求的产品版本，初步形成产品线，可进行多项目协同
    - 已共享为核心面向客户需求阶段：形成了规模客户，针对客户做产品规划、技术规划；有了产品项目的成本控制，以及对市场和财务的考量
    - 以产业链为核心的关注利润阶段：公司形成明确预算及策略管理，部门以及环节都围绕产出，有良好的价值导向，形成以责任、权利、利益的分配体系，领导大多管理创新
    - 持续改进阶段：以财务为中心进行核算，围绕核心竞争力、产出进行提升、IT系统高效支持运转运作
    - ![](image/11.png)
  - 从以上阶段可以看出，我们公司目前子啊二级和三级之间，如果要在往前推进，实现集成产品开发管理，如何实现产品开发准确、快速、低成本、高质量的目标，在前面已经有所介绍：“四四四”模型，核心主要有四大重组
    - 财务重组
    - 市场重组
    - 产品重组
    - 组织与流程重组